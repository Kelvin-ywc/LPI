...
_C.LPAI = CN()
_C.LPAI.VISUAL_PROMPT = True
_C.LPAI.TEXTUAL_PROMPT = True

_C.LPAI.TASK_ALIGNMENT = True
_C.LPAI.LAYER_ALIGNMENT = True

_C.LPAI.INTERACT =  True

_C.LPAI.PROMPT_DEPTH = 9
_C.LPAI.PROMPT_LORA_D = 4
_C.LPAI.INTERACT_LORA_D = 4
_C.LPAI.PROMPT_LORA = True
_C.LPAI.EPOCH = 5
_C.LPAI.INTERACT_TYPE = "linear" # maple, dcp
_C.LPAI.PROMPT_LENGTH = 16
_C.LPAI.INTERACT_DEPTH = 9
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
